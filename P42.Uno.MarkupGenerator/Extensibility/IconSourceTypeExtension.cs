...
internal class IconSourceTypeExtension : ITypeExtension
{
    public bool CanExtend(string qualifiedTypeName)
    {
        //return false;
        return qualifiedTypeName == "global::Microsoft.UI.Xaml.Controls.IconSource";
    }
    ...
    {
        Helpers.IconExtension.CreateIconExtensions(createBuilder, prop.Name, "element", true, "ATTACHED ICON SOURCE");
    }
    ...
    public void WriteDependencyPropertyExtensions(
      ...
      Func<MethodBuilder> createBuilder)
    {
        Helpers.IconExtension.CreateIconExtensions(createBuilder, info.PropertyName, "element", true, "DEPENDENCY ICON SOURCE");
    }
    ...
    public void WriteStyleBuilderExtensions(
      ...
      Func<MethodBuilder> createBuilder)
    {
        Helpers.IconExtension.CreateIconExtensions(createBuilder, info.PropertyName, "builder", true, "STYLE ICON SOURCE");
    }
